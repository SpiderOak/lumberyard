...
_test_cases = [
    ...
    (u"xxx list key versions aaa", {"command" : ncl_list_key_versions,
                                    "collection_name" : "xxx",
                                    "key" : "aaa"}),
    (u"xxx list key aaa", {"command" : ncl_list_key,
                           "collection_name" : "xxx",
                           "key" : "aaa"}),
    (u"xxx list key aaa version=zzz", {"command" : ncl_list_key,
                                        "collection_name" : "xxx",
                                        "key" : "aaa",
                                        "version" : "zzz" }),
    (u"xxx archive key aaa", {"command" : ncl_archive_key,
                              "collection_name" : "xxx",
                              "key" : "aaa"}),
    (u"xxx archive key aaa /ppp/file1", {"command" : ncl_archive_key,
                                         "collection_name" : "xxx",
                                         "key" : "aaa",
                                         "paths" : [u"/ppp/file1"]}),
    (u"xxx retrieve key aaa", {"command" : ncl_retrieve_key,
                              "collection_name" : "xxx",
                              "key" : "aaa"}),
    (u"xxx retrieve key aaa dest=/ppp/file1", {"command" : ncl_retrieve_key,
                                               "collection_name" : "xxx",
                                               "key" : "aaa",
                                               "dest" : u"/ppp/file1"}),
    (u"xxx delete key aaa", {"command" : ncl_delete_key,
                             "collection_name" : "xxx",
                             "key" : "aaa"}),
]
